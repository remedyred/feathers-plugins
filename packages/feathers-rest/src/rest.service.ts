...
export default class RestService<T = any, D = Partial<T>, P extends AdapterParams = AdapterParams> extends RestAdapter implements ServiceMethods<Paginated<T> | T, D, P> {
