...
export default class QueueService<T = any, D = Partial<T>, P extends QueueParams = QueueParams> extends QueueAdapter implements ServiceMethods<T | Paginated<T>, D, P> {
